...
-- Inside oil the fork's default signcolumn is "yes:2" (upstream: "no"): git_status
-- draws two signs per line. Outside oil it must go back to the editor's "auto".
a.describe("window options", function()
  ...
  a.it("Restores window options on close", function()
    ...
    test_util.oil_open()
    assert.equals("yes:2", vim.o.signcolumn)
    oil.close()
